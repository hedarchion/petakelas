...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <div className="w-full md:w-80 bg-zinc-950 border-l border-zinc-800 flex flex-col h-full overflow-y-auto shadow-2xl">
      <div className="p-6 space-y-8">
        ...
        <div className="flex items-center justify-between">
            ...
            {onClose && (
                <button 
                    onClick={onClose}
                    className="lg:hidden p-2 text-zinc-400 hover:text-white bg-zinc-900 rounded-lg"
                >
                    <X className="w-5 h-5" />
                </button>
            )}
